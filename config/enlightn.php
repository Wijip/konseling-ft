...
return [
    ...
    */
    ...
    'exclude_analyzers' => [
        // Server/OS-level checks — cannot be fixed via application code
        \Enlightn\Enlightn\Analyzers\Performance\MysqlSingleServerAnalyzer::class,  // Check 11: Unix socket (Windows incompatible)
        \Enlightn\Enlightn\Analyzers\Performance\OpcacheAnalyzer::class,             // Check 12: OPcache (php.ini setting)
        \Enlightn\Enlightn\Analyzers\Security\FilePermissionsAnalyzer::class,        // Check 53: File permissions (NTFS on Windows)
        \Enlightn\Enlightn\Analyzers\Security\PHPIniAnalyzer::class,                 // Check 62: PHP.ini config (server setting)
    ],
    ...
    */
    'analyzer_paths' => [
        'Enlightn\\Enlightn\\Analyzers' => base_path('vendor/exin/enlightn/src/Analyzers'),
        'Enlightn\\EnlightnPro\\Analyzers' => base_path('vendor/exin/enlightnpro/src/Analyzers'),
    ],
