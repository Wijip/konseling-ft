...
@section('content')
    <div
        ...
        <h1 style="font-size: 1.5rem; font-weight: 700; color: #111827; margin-top: 1rem;">Halaman Tidak Ditemukan</h1>
        <p style="color: #6B7280; margin-top: 0.5rem; max-width: 400px;">Maaf, halaman yang Anda cari tidak tersedia atau
            telah dipindahkan.</p>
        <a href="{{ url('/') }}"
