...
@section('content')
    <div
        ...
        <div style="font-size: 6rem; font-weight: 800; color: #E5E7EB; line-height: 1;">500</div>
        <h1 style="font-size: 1.5rem; font-weight: 700; color: #111827; margin-top: 1rem;">Terjadi Kesalahan Server</h1>
        <p style="color: #6B7280; margin-top: 0.5rem; max-width: 400px;">Maaf, terjadi kesalahan pada server. Silakan coba
            lagi nanti atau hubungi admin.</p>
        <a href="{{ url('/') }}"
